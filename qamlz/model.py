    ...
    def pick_excited_states(self, iter, excited_states, mu):
        for excited_state in excited_states:
            ...
            for state in range(np.size(excited_state)):
                ...
                test_state[state] = 0
                test_energy = total_hamiltonian(
                    mu, test_state, new_sigma, self.env.C_i, self.env.C_ij
                )
        ...
        for i in range(self.config.n_iterations):
            ...
            for mu in mus:
                ...
                for excited_states in excited_states_arr:
                    new_mus_arr.append(
                        [self.pick_excited_states(i, excited_states, mu)]
                    )
